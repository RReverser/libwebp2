...
class DeblockingFilter {
 public:
  DeblockingFilter(const DecoderConfig& config,
                   const BitstreamFeatures& features,
  ...
  static void DeblockEdge(const DecoderConfig& config, bool intertile,
                          ...
                          const Rectangle& edge_rect, YUVPlane* const pixels);
 ...
 private:
  ...
  const BitstreamFeatures& features_;
 ...
 public:
  ...
  static uint32_t GetSharpnessFromQuality(uint32_t quality_hint);
