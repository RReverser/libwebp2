...
class IntertileFilter {
 public:
  ...
  void Init(const DecoderConfig& config, const BitstreamFeatures& features,
            const GlobalParams& gparams, const TilesLayout& tiles_layout,
